...
class Product extends \XLite\View\Model\AModel
{
    ...
    protected $schemaDefault = array(
        ...
        'brand' => array(
            self::SCHEMA_CLASS    => 'XLite\View\FormField\Input\Text',
            self::SCHEMA_LABEL    => 'Product Brand',
            self::SCHEMA_REQUIRED => false,
        ),
        'model' => array(
            self::SCHEMA_CLASS    => 'XLite\View\FormField\Input\Text',
            self::SCHEMA_LABEL    => 'Product Model',
            self::SCHEMA_REQUIRED => false,
        ),
        'power_source' => array(
            self::SCHEMA_CLASS    => 'XLite\View\FormField\Input\Text',
            self::SCHEMA_LABEL    => 'Power Source',
            self::SCHEMA_REQUIRED => false,
        ),
        'condition' => array(
            self::SCHEMA_CLASS    => 'XLite\View\FormField\Input\Text',
            self::SCHEMA_LABEL    => 'Condition Of Your Tool',
            self::SCHEMA_REQUIRED => false,
        ),
        'additional_details' => array(
            self::SCHEMA_CLASS    => 'XLite\View\FormField\Textarea\Advanced',
            self::SCHEMA_LABEL    => 'Additional Components Description',
            self::SCHEMA_REQUIRED => false,
    ...
    {
        return 'XLite\Module\Shofi\ToolListing\View\Form\Model\Tool';
    }
