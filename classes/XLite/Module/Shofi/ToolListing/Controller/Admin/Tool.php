...
/**
 * Copyright (c) 2011-present Toolmates Software Sollution All rights reserved.
 * See https://toolmateshire.com.au/license for license details.
 */

namespace XLite\Module\Shofi\ToolListing\Controller\Admin;

/**
 * Product
 */
class Tool extends \XLite\Controller\Admin\ACL\Catalog
{
    ...
    public function doNoAction() {
        ...
        if($firstAddress) {
            ...
            $this->setReturnURL(
                $this->buildURL('address_book'));
            \XLite\Core\TopMessage::addInfo(
                'Please add an address before adding a tool.'
            );
        }
    }
    ...
    {
        xdebug_break();
        return '\XLite\Module\Shofi\ToolListing\View\Model\Product';
    }
    ...
    public function getPages()
    {
        ...
        $list['tool'] = static::t('Tool');

        if (!$this->isNew()) {
            $list['shippingMarketing'] = static::t('Shipping And Marketing');
        }
    ...
    protected function getPageTemplates()
    {
        ...
        $list['tool']    = 'modules/Shofi/ToolListing/product/info.twig';
        $list['default'] = 'modules/Shofi/ToolListing/product/info.twig';

        if (!$this->isNew()) {
            $list['shippingMarketing']  = 'modules/Shofi/ToolListing/product/shipping_marketing.twig';
        }
    ...
    protected function doActionUpdate()
    {
        ...
        xdebug_break();
        $formModel = new \XLite\Module\Shofi\ToolListing\View\FormModel\Product\Info(['object' => $dto]);
        ...
        $this->setReturnURL($this->buildURL('tool', '', $params));
    }
    ...
    {
        xdebug_break();
        return new \XLite\Module\Shofi\ToolListing\Model\DTO\Product\Info($this->getProduct());
    }
    ...
    /**
     * Shipping and Marketing Tab Section in Product
     */

    public function getShippingMarketingModelForm(array $params = array())
    {
        xdebug_break();
        $class = 'XLite\Module\Shofi\ToolListing\View\Model\ShippingMarketing';
     ...
     * @return void
     */
    protected function doActionUpdateShippingMarketing()
    {
        xdebug_break();
        $dto = $this->getShippingMarketingFormModelObject();
        $product = $this->getProduct();
        $isPersistent = $product->isPersistent();
        $formModel = new \XLite\Module\Shofi\ToolListing\View\FormModel\Product\ShippingMarketing(['object' => $dto]);
        ...
        if ($form->isValid()) {
            xdebug_break();
            $dto->populateTo($product, $data[$this->formName]);
            xdebug_break();
     ...
     * @return \XLite\Model\DTO\Base\ADTO
     */
    public function getShippingMarketingFormModelObject()
    {
        xdebug_break();
        return new \XLite\Module\Shofi\ToolListing\Model\DTO\Product\ShippingMarketing($this->getProduct());
    }
