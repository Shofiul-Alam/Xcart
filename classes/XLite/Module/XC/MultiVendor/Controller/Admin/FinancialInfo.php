 ...
 */
class FinancialInfo extends \XLite\Controller\Admin\AAdmin
{
    /**
    ...
    public function checkACL()
    {
        ...
        return parent::checkACL()
            ...
            || ($profile && $profile->getProfileId() === Core\Auth::getInstance()->getVendorId());
    }
    ...
    {
        return 'XLite\Module\XC\MultiVendor\View\Model\Profile\FinancialInfo';
    }
     ...
     * @return void
     */
    protected function doActionUpdatePaypalStatus()
    {
        $this->getProfile()->renewPaypalLoginStatus();
        \XLite\Core\Database::getEM()->flush();

        $this->setReturnURL(
            $this->buildURL('financialInfo', '', array('profile_id' => $this->getProfile()->getProfileId()))
        );
    }
}
